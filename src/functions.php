...
function bulmawp_enqueue() {
	wp_enqueue_style( 'bulma-css', 'https://cdnjs.cloudflare.com/ajax/libs/bulma/0.7.4/css/bulma.min.css', '', '0.7.4' );
	wp_enqueue_style( 'bulmawp', get_template_directory_uri() . '/style.css');
